...
export function FancyCard({ title, description, steps, footer }: CardData) {
  return (
    <CardSpotlight className="h-full w-full bg-opacity-0 cursor-pointer border-none dark:border-none">
      ...
      <p className="dark:text-neutral-200 text-neutral-900 mt-4 relative z-20 text-sm">
        {footer}
      </p>
    </CardSpotlight>
  );
...
export const CheckIcon = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className="h-4 w-4 text-pink-500 mt-1 flex-shrink-0"
    >
